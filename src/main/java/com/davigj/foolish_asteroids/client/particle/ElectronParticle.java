...
@OnlyIn(Dist.CLIENT)
public class ElectronParticle extends TextureSheetParticle {

    private ElectronParticle(ClientLevel worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double particleRedIn, double particleGreenIn, double particleBlueIn) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ElectronParticle particle = new ElectronParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
